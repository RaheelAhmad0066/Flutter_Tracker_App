  ...
  Widget speedometer() {
    ...
    return   Positioned(
        ...
        child:  Speedometer(
          ...
          displayTextStyle: TextStyle(fontSize: 16, color: Colors.black,fontFamily: 'digital_font',fontWeight: FontWeight.bold ),
          displayNumericStyle: TextStyle(fontSize: 16, color: Colors.red,fontFamily: 'digital_font',fontWeight: FontWeight.bold,height: 40),
          onComplete: (){
            print("ON COMPLETE");
          },
        )
...
/*    Fluttertoast.showToast(
    ...
    if(int.tryParse(devicelist.speed.toString())! > 0){
      ...
      if(prefs.get(devicelist.deviceData!.imei.toString())!=null)
        iconpath =  "assets/tbtrack/"+prefs.get(devicelist.deviceData!.imei.toString()).toString()+"toprunning.png";
      ...
      if(prefs.get(devicelist.deviceData!.imei.toString())!=null)
        iconpath =  "assets/tbtrack/"+prefs.get(devicelist.deviceData!.imei.toString()).toString()+"topstop.png";
    }
  ...
  Widget _showStatusPopup(double boxImageSize) {
    ...
    return (_statusbarLoading12)?Positioned(
      bottom: 20,
      right: 10,
      left: 10,
      child: Align(
