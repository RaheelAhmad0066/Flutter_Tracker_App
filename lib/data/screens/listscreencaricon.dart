  ...
  Widget _buildItem(deviceItems productData, boxImageSize, index){
    ...
    if (productData.speed!.toInt() > 0) {
      ...
      if(prefs.get(productData.deviceData!.imei.toString())!=null)
        iconpath =  "assets/speedoicon/"+prefs.get(productData.deviceData!.imei.toString()).toString()+"grn.png";
      ...
      if(prefs.get(productData.deviceData!.imei.toString())!=null)
        iconpath =  "assets/speedoicon/"+prefs.get(productData.deviceData!.imei.toString()).toString()+"red.png";
                ...
                child: Row(
                  ...
                  children: <Widget>[
                   ...
                   Container(
                      ...
                      child:Image.asset(iconpath/*"assets/rotatingicon/2.png"*/, height: boxImageSize,width: boxImageSize)
                    ),
